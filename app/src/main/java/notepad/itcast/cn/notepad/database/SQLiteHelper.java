...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    @Override
    public void onUpgrade(SQLiteDatabase db,int oldVersopm,int newVersion){}
    ...
    public boolean deleteData(String id){
        ...
        String[] conventValuesArray=new String[]{String.valueOf(id)};
        return sqLiteDatabase.delete(DBUtils.DATABASE_TABLE,sql,conventValuesArray)>0;
    }
